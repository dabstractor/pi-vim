...
const THRESHOLDS = {
  maxFiles: 12,
  // WORD/delimited text objects, mode-color settings, matching-pair
  // motion, and render caching add package surface. Keep budgets tight
  // enough to catch accidental docs/tests in the package.
  maxSize: 32300,
  maxUnpackedSize: 141900,
} as const;
